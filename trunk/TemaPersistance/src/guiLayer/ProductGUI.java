...
public class ProductGUI extends JPanel {
	...
	public ProductGUI() {
		...
		prodTable.setModel(new DefaultTableModel(new Object[][] {},
		...
		panel.setLayout(new FormLayout(new ColumnSpec[] { ColumnSpec
				...
				FormFactory.RELATED_GAP_ROWSPEC, RowSpec.decode("135dlu"),
		...
		gl_panel_3.setHorizontalGroup(gl_panel_3.createParallelGroup(
				Alignment.LEADING).addComponent(panel_4,
		...
		panel_2.setBorder(new TitledBorder(null, "Create",
				TitledBorder.LEADING, TitledBorder.TOP, null, null));
		...
		gl_panel_2.setHorizontalGroup(gl_panel_2.createParallelGroup(
				Alignment.LEADING).addComponent(panel_6,
				GroupLayout.DEFAULT_SIZE, 238, Short.MAX_VALUE));
		gl_panel_2.setVerticalGroup(gl_panel_2.createParallelGroup(
				Alignment.LEADING).addGroup(
				gl_panel_2
						.createSequentialGroup()
						.addComponent(panel_6, GroupLayout.PREFERRED_SIZE,
		...
		cmbCreateType.setModel(new DefaultComboBoxModel(new String[] { "None",
				"Clothing", "Gunreplica", "Equipment" }));
		...
		panel_7.setBorder(new TitledBorder(null, "Type", TitledBorder.LEADING,
