...
public class MockUp2 extends JFrame {
	...
	public MockUp2() {
		...
		btnSearchProduct.setBounds(541, 105, 105, 23);
		...
		JLabel lblNewLabel_3 = new JLabel("S\u00F8gehall\u00F8j:");
		lblNewLabel_3.setBounds(541, 14, 94, 14);
		panel.add(lblNewLabel_3);
		
		JLabel lblNewLabel_4 = new JLabel("S\u00F8gehall\u00F8j:");
		lblNewLabel_4.setBounds(541, 45, 94, 14);
		panel.add(lblNewLabel_4);
		
		JLabel lblSgehallj = new JLabel("S\u00F8gehall\u00F8j:");
		...
		list.setModel(new AbstractListModel() {
			String[] values = new String[] {"Sko", "T\u00F8j", "Noget"};
			public int getSize() {
		...
		btnAddSelectedProduct.setBounds(655, 105, 135, 23);
