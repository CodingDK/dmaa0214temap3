...
public class DBCustomer implements IFDBCustomer {
	...
	public int insertCustomer(Customer cust) {
		int rc = -1;
		int zipInsert = new DBZipcode()
				.updateOrInsertZipcode(cust.getZipcode());
		if (zipInsert != -1) {
			try {
	...
	private Customer buildCustomer(ResultSet results) {
		...
		try {
			...
			Zipcode zipObj = new Zipcode(results.getInt("zipcode"),
	...
	private String buildQuery(String wQuery) {
		String query = "select * from CUSTOMER" + " join ZIPCODES on"
